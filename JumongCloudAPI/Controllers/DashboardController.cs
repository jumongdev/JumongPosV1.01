...
public class DashboardController : ControllerBase
{
    ...
    [HttpGet("stores")]
        ...
        {
            return Ok(new { version = "1.0.16", buildDate = "2026-06-08", changes = "Void re-sync fix + expense details + voided amount card + PH timezone", downloadUrl = "https://github.com/jumongdev/JumongPosV1.01/releases/download/v1.0.16/JumongPosV1.01.exe" });
        }
