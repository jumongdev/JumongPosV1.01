...
## Latest Change (2026-08-27) — v1.1.60 (API + POS client) + web: E-COMMERCE STOCK HOLD — items HELD at SUBMIT (not CONFIRM) + HQ POS "naka hold sa online" message + cancel releases all
