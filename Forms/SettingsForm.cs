...
public partial class SettingsForm : Form
{
    ...
    private void btnSyncLog_Click(object? sender, EventArgs e)
    {
        ...
        dgv.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "CreatedAt", HeaderText = "TIME", Width = 140, DefaultCellStyle = new DataGridViewCellStyle { Format = "yyyy-MM-dd HH:mm", ForeColor = Color.FromArgb(200, 200, 220) } });
    ...
    {
        ShowSyncProgress("Downloading Customers...", async p =>
        {
            p.Report("Downloading customer list from cloud...");
            var count = await SyncService.DownloadCustomersAsync();
            return count;
        });
    }
